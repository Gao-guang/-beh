...
(cl:defmethod cl:initialize-instance :after ((m <test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name chat_my2-msg:<test> is deprecated: use chat_my2-msg:test instead.")))

(cl:ensure-generic-function 's-val :lambda-list '(m))
(cl:defmethod s-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chat_my2-msg:s-val is deprecated.  Use chat_my2-msg:s instead.")
  (s m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chat_my2-msg:x-val is deprecated.  Use chat_my2-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader chat_my2-msg:y-val is deprecated.  Use chat_my2-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<test>)))
  ...
  "773945f4ca27234189a5ae6671065ad3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'test)))
  "Returns md5sum for a message object of type 'test"
  "773945f4ca27234189a5ae6671065ad3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<test>)))
  ...
  (cl:format cl:nil "string s~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'test)))
  "Returns full string definition for message of type 'test"
  (cl:format cl:nil "string s~%float32 x~%float32 y~%~%~%"))
